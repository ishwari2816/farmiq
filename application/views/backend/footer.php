<div class="main-content" style="margin-left: 250px;padding: 20px;margin-top: 20px;">
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded-top p-4">
            <div class="row">
                <div class="col-12 col-sm-6 text-center text-sm-start">
                    &copy; <a href="#">APMC by Nashik Developers Team</a>, All Right Reserved.
                </div>
                <div class="col-12 col-sm-6 text-center text-sm-end">
                    Designed By <a href="https://htmldesigner.com">HTML Coder</a>
                    Distributed By <a class="border-bottom" href="https://noneed.com" target="_blank">Team</a>
                </div>
            </div>
        </div>
    </div>
